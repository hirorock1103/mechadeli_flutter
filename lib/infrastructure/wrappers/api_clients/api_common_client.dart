...
part 'api_common_client.chopper.dart';

@ChopperApi(baseUrl: '')
abstract class ApiCommonClient extends ChopperService {
  static ApiCommonClient create([ChopperClient? client]) => _$ApiCommonClient(client);
