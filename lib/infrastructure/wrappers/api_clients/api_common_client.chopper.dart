...
part of 'api_common_client.dart';
...
class _$ApiCommonClient extends ApiCommonClient {
  _$ApiCommonClient([ChopperClient? client]) {
    if (client == null) return;
    this.client = client;
  }

  @override
  final definitionType = ApiCommonClient;
