...
part of 'user_register_notifier.dart';
...
abstract class $UserRegisterStateCopyWith<$Res> {
  factory $UserRegisterStateCopyWith(
      ...
      _$UserRegisterStateCopyWithImpl<$Res>;
  $Res call(
      {String inputName,
      String inputEmail,
      String inputPw,
...
/// @nodoc
class _$UserRegisterStateCopyWithImpl<$Res>
    implements $UserRegisterStateCopyWith<$Res> {
  _$UserRegisterStateCopyWithImpl(this._value, this._then);

  final UserRegisterState _value;
  // ignore: unused_field
  final $Res Function(UserRegisterState) _then;
...
class __$$_UserRegisterStateCopyWithImpl<$Res>
    extends _$UserRegisterStateCopyWithImpl<$Res>
  ...
  __$$_UserRegisterStateCopyWithImpl(
      ...
      : super(_value, (v) => _then(v as _$_UserRegisterState));

  @override
  _$_UserRegisterState get _value => super._value as _$_UserRegisterState;
...
class _$_UserRegisterState
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'UserRegisterState(inputName: $inputName, inputEmail: $inputEmail, inputPw: $inputPw, inputPwConfirm: $inputPwConfirm, count: $count, currentFlow: $currentFlow)';
  }
...
abstract class _UserRegisterState implements UserRegisterState {
  const factory _UserRegisterState(
      ...
      final String inputPwConfirm,
      final int count,
      final MechadeliFlow currentFlow}) = _$_UserRegisterState;
