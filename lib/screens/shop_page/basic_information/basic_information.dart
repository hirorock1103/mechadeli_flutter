...
// class _BasicInformationState extends State<BasicInformation> {
  ...
  Widget buildContents(BuildContext context) {
    ...
    ///通常配列用
    Map<String, String> editStringMap = {};
    shopFormat.toJson().entries.forEach((e) {
      editStringMap[e.key] = "";
    });
    shop.toJson().entries.forEach((e) {
      editStringMap[e.key] = e.value.toString();
    });
              ...
              return MyCard(
                ...
                child: Column(
                  children: [
                    ...
                    ///作り変えたほうがいい？　問題controllerが問題かしらんけど再ビルドが毎回走ってうっとおしい
                    // buildRowCallBack("店舗コード", "", editStringMap['shop_code']! , (value){ print(value); }),

                    buildRow("店舗コード", "", editMap['shop_code']!),
                    buildRow("店舗名", "", editMap['name']!),
                    buildRow("店舗オーナー名", "", editMap['shop_owner_name']!),
                    buildRow(
                        "住所（郵便番号）", "", editMap['shop_address_post_number']!),
                    ...
                    ElevatedButton(
                        onPressed: () async {
                          ...
                          data["shop_owner_name"] =
                              editMap['shop_owner_name']!.text;
                          data["shop_address_post_number"] =
                              editMap['shop_address_post_number']!.text;
                          data["shop_address_pref"] =
                              editMap['shop_address_pref']!.text;
                          data["shop_address_city"] =
                              editMap['shop_address_city']!.text;
                          data["shop_address_town"] =
                              editMap['shop_address_town']!.text;
                          data["shop_address_buildings"] =
                              editMap['shop_address_buildings']!.text;
                          int shopId = Shop.me.id;
                          context
                              .read<BasicInformationNotifier>()
  ...
  Widget buildRowCallBack(
      String title, String hintText, ValueChanged onChange) {
